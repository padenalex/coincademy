...
global $post;
$current_lesson = new LLMS_Lesson($post->ID);
$current_lesson_id = $current_lesson->get('id');
						...
						<li>
							...
							<span class="lesson-title <?php echo ( $is_complete ? 'done' : '' ); ?>">
								...
								<?php if ( $lesson->is_free() || ( $student && ! $restricted['is_restricted'] ) ) : ?>
									...
									<a <?php if($current_lesson_id == $lesson->get('id')) { echo 'class="current-lesson"'; }?> href="<?php echo get_permalink( $lesson->get( 'id' ) ); ?>">
