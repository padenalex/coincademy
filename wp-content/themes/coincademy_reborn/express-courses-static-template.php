            ...
            <div class="pure-g vmid">
                <div class="pure-u-1 pure-u-md-1-2 pure-u-lg-1-2">
                    ...
                    <div class="mc-field-group input-group">
                        <strong>Group </strong>
                        <ul><li><input type="checkbox" value="1" name="group[6427][1]" id="mce-group[6427]-6427-0"><label for="mce-group[6427]-6427-0">A</label></li>
                    <li><input type="checkbox" value="2" name="group[6427][2]" id="mce-group[6427]-6427-1"><label for="mce-group[6427]-6427-1">B</label></li>
                    <li><input type="checkbox" value="4" name="group[6427][4]" id="mce-group[6427]-6427-2"><label for="mce-group[6427]-6427-2">C</label></li>
                    </ul>
                    </div>
