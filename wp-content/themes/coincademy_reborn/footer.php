			<section class="gradient-general cta-hold">
        	<div class="max-width pure-g vmid ">
        		...
        		<div class="pure-u-1 pure-u-md-1-2 pure-u-lg-1-2">
                    ...
                    <div id="mc_embed_signup" class="footer-newsletter-signup">
                    ...
                    <div class="mc-field-group">
                        ...
                        <div class="clear"><input type="submit" value="Sign Up" name="subscribe" id="mc-embedded-subscribe" class="cta-white"></div>
                        </div>
                    </form>
                    </div>
			...
			<footer class="max-width pure-g">
				...
				<div class="pure-u-1 pure-u-md-1-5 pure-u-lg-1-5">
					<span class="logo-img logo-icon"></span>
				</div>
