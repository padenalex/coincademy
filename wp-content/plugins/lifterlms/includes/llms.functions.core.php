...
function llms_form_field( $field = array(), $echo = true ) {
	...
	switch ( $field['type'] ) {
		...
		case 'reset':
		case 'submit':
			$r .= '<button class="button green-btn green-btn-padding llms-field-button' . $field['classes'] . '" id="' . $field['id'] . '" type="' . $field['type'] . '"' . $disabled_attr . $name_attr . $field['style'] . '>' . $field['value'] . '</button>';
			break;
